...
<div className="flex justify-center items-center mt-6 space-x-4">
    <button
        ...
        className={`px-4 py-2 rounded-lg transition-all ${
            currentPage === 1 ? "bg-gray-600 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-700"
        }`}
    >
        Previous
    </button>
    ...
    <button
        ...
        className={`px-4 py-2 rounded-lg transition-all ${
            currentPage === totalPages ? "bg-gray-600 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-700"
        }`}
    >
        Next
    </button>
